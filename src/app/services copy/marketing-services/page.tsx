...
export async function generateMetadata() {
  ...
  const metadata: Metadata = {
    title: 'Service safe hands | Corporative Services',
    description: '',
    keywords: '',
