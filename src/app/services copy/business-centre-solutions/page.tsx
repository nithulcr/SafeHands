            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                ...
                <div className='text-[#8C8C8C] flex flex-col gap-4'>
                  ...
                  <p>For companies looking for flexibility, our Business Center offers fully equipped spaces, private offices, and coworking options that can be scaled as your business expands. Whether you need occasional meeting space, a temporary setup, or a long-term virtual presence, safe hands provides customized solutions that adapt to your goals.</p>
