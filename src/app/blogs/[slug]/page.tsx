...
export default function BlogPostPage({ params: initialParams }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <section className="other-section pt-10 lg:pt-16 pb-5 lg:pb-16 overflow-hidden relative">

        <div className="max-w-[1250px] px-6 w-full mx-auto pt-14 lg:pt-20 relative">
          ...
          <div className='mx-auto'>
            ...
            <p className=" mb-6 mx-auto opacity-70">
              {post.content}
            </p>
