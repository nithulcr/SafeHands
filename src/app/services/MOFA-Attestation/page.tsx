...
export async function generateMetadata() {
  ...
  const metadata: Metadata = {
    title: 'Service safe hands | MOFA Attestation',
    description: '',
    keywords: '',
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <div className='text-[var(--color)] flex flex-col gap-4'>
                  ...
                  <p className='font-light'>
                    At SafeHands, we handle MOFA attestation as a seamless extension of the entire legalisation journey. We manage the submission, verification, approval, and final collection, ensuring that the process is as quick and stress-free as possible. Since MOFA attestation requires precise documentation and fee payments, our team ensures everything is prepared in advance so there are no delays.
                  </p>
                  <p className='font-light'>
                    Whether it is a degree certificate for employment, a marriage certificate for family sponsorship, a commercial license for business setup, or a medical certificate for legal use, SafeHands ensures every document receives the official recognition it needs to be used confidently in the UAE.
                  </p>
