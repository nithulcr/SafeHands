...
export async function generateMetadata() {
  ...
  const metadata: Metadata = {
    title: 'Service safe hands | Commercial Document Attestation',
    description: '',
    keywords: '',
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <div className='text-[var(--color)] flex flex-col gap-4'>
                  ...
                  <p className='font-light'>
                    Businesses rely on SafeHands because we offer unmatched clarity, quick processing, and strict compliance. Whether a startup, SME, or multinational corporation, our commercial attestation solutions ensure that every document is validated according to the highest international standards. With SafeHands, businesses save time, avoid legal complications, prevent compliance issues, and maintain smooth operations across borders.
                  </p>
                </div>
