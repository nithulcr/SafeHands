                ...
                <div className='flex flex-col gap-6 my-7'>
                  ...
                  <div className='grid md:grid-cols-2 gap-6'>
                    ...
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>
                      ...
                      <p className='text-[var(--color)] font-light'>The UK follows a notary-driven process that leads to Foreign Commonwealth Office (FCO) legalisation before reaching the UAE Embassy. The documents must meet UK notarial standards, which our team ensures before submission. The attested document is then legalised by the MOFA UAE for final acceptance.</p>
                    </div>
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>
                    ...
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>
                      ...
                      <p className='text-[var(--color)] font-light'>Canadian documents follow a similar structured process involving notarization, authentication through Global Affairs Canada, and UAE Embassy legalisation. SafeHands ensures that educational, personal, and corporate documents meet all the technical requirements set by Canadian authorities.</p>
                    </div>
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>

                      <h5 className='text-lg md:text-xl font-semibold mb-2'>Europe</h5>
                      <p className='text-[var(--color)] font-light'>Documents from European countries often undergo validation through their Ministry of Justice or Ministry of Foreign Affairs before being legalised by the UAE Embassy. Whether the document originates from Germany, France, Italy, the Netherlands, or Scandinavian countries, SafeHands ensures full compliance with European legalisation standards.</p>
                    </div>
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>

                      <h5 className='text-lg md:text-xl font-semibold mb-2'>Africa</h5>
                      <p className='text-[var(--color)] font-light'>African countries follow diverse attestation processes depending on their local administrative structure. SafeHands manages documentation from Nigeria, Kenya, Ghana, South Africa, and others, ensuring every verification step is completed accurately, even when local procedures vary widely.</p>
                    </div>
                    <div className='bg-white p-5 lg:p-7 rounded-2xl  text-sm '>

                      <h5 className='text-lg md:text-xl font-semibold mb-2'>GCC Countries</h5>
                      <p className='text-[var(--color)] font-light'>Documents from Saudi Arabia, Bahrain, Kuwait, Qatar, and Oman follow their own government authentication pathways. SafeHands offers cross-border attestation for GCC nations, ensuring documents can be used either within the UAE or internationally.</p>
                    </div>
