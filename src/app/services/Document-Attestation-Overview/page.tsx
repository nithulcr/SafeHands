...
export async function generateMetadata() {
  ...
  const metadata: Metadata = {
    title: 'Service safe hands | Document Attestation Overview',
    description: '',
    keywords: '',
              ...
              <div>
                <div className='text-[#8C8C8C] flex flex-col gap-4'>
                  ...
                  <p className='font-light'>
                    SafeHands ensures that your documents move through every stage smoothly. We begin by reviewing the document for formatting errors, incorrect details, or missing seals. Once verified, the document proceeds through various departments such as notary offices, state authorities, foreign ministries, and international embassies. The final stage often includes MOFA attestation, which makes the document valid inside the UAE.
                  
                  </p>
                  <p className='font-light'>
                    What makes SafeHands unique is our ability to handle variations in documents, country-specific rules, and embassy protocols with professionalism and clarity. Every document undergoes a custom-designed route depending on its type—educational, personal, or commercial—and the country where it will be used. With SafeHands, the entire attestation journey becomes predictable, transparent, and stress-free.
                  </p>
                </div>
