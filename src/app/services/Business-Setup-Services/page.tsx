...
export async function generateMetadata() {
  ...
  const metadata: Metadata = {
    title: 'Service safe hands | Family Visa Documentation Support',
    description: '',
    keywords: '',
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <div className='text-[var(--color)] flex flex-col gap-4'>
                  ...
                  <p className='font-light'>
                  SafeHands supports families by ensuring that every document—marriage certificates, birth certificates, tenancy contracts, salary statements, bank statements, and identification documents—is carefully reviewed and prepared. We guide clients through each requirement, explaining the process in simple terms while taking full responsibility for the attestation, legalisation, and translation.
                  </p>
                  <p className='font-light'>
                  For new residents, long-term expatriates, and Golden Visa holders, our service ensures that family reunification happens smoothly and without complications. SafeHands works with government portals, immigration systems, and ministry channels to provide a complete documentation solution that supports the dream of living together in the UAE.
                  </p>
