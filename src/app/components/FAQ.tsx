    ...
    <section className="bg-[#D5E5E3] py-14 lg:py-24 rounded-3xl">
      <div className="max-w-[1250px] mx-auto px-6">
        <motion.div
          ...
          transition={{ duration: 0.5 }} className="heading flex flex-col text-site items-center max-w-[450px] mx-auto mb-8 mx-auto px-6">
          ...
          <h2 ref={fadeRef} className="text-center fade-up-stagger text-2xl lg:text-[36px] font-medium mb-1 leading-tight">
